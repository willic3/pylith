...
protected:
    ...
    void setUp(void) {
        ...
        journal::debug_t debugP("timedependent");
        // debugP.activate();
        ...
        _data->normalizer->setLengthScale(40.0e+03);
        _data->normalizer->setTimeScale(15.0);
        _data->normalizer->setDensityScale(2500.0);
        _data->normalizer->computePressureScale();

        _data->startTime = 0.0;
        _data->endTime = 0.1;
        _data->timeStep = 0.05;
        _data->isExplicit = true;
    ...
    void _setExactSolution(void) {
        ...
        err = PetscDSSetExactSolution(prob, 1, solnkernel_vel, NULL);CPPUNIT_ASSERT(!err);
    } // _setExactSolution
